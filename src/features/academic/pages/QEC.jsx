        ...
        <section className="flex-1 py-10">
          ...
          <div className="space-y-6 text-gray-800">
            ...
            <div>
              ...
              <p className="mb-3">To advance the mission, Hazara University will:</p>
