...
const FeeStructure = React.memo(() => {
    ...
    // The sections exactly as they appear in the provided Fee Structure image
    const sections = [
        {
            id: 'bs-programs',
            title: "Fee Structure (BS Programs)",
        ...
        },
        {
            ...
            title: "Fee Structure (MS/M.Phil/M.Sc (Hons) Programs)",
        ...
        {
            id: 'phd-programs',
            title: "Fee Structure (Ph.D Programs)",
