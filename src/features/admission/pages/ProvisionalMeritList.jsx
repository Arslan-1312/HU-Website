...
const ProvisionalMeritList = () => {
    const programLevels = [
        {
            level: "bs",
            title: "BS Programs",
            description: "Click to view all BS provisional merit lists",
            icon: "fas fa-user-graduate",
            path: "/admissions/merit-list/provisional/bs"
        },
        {
            level: "ms",
            title: "MS/MPhil Programs",
            description: "Click to view all MS/MPhil provisional merit lists",
            icon: "fas fa-user-graduate",
            path: "/admissions/merit-list/provisional/ms"
        },
        {
            level: "phd",
            title: "PhD Programs",
            description: "Click to view all PhD provisional merit lists",
            icon: "fas fa-user-graduate",
            path: "/admissions/merit-list/provisional/phd"
        }
    ];
...
export default ProvisionalMeritList;
